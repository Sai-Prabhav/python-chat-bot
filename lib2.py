...
class date_time:
    def time():
        ...
        if int(hours) > 12:
            ...
            current_hours += 12
        say(str(current_hours)+":"+str(minutes)+":"+str(seconds)+" "+mode)
    def date():
        ...
        year_d = "20"+str(year)
        say(date+date_m+" "+month_d+" "+year_d)
class cryptography:
    def encrypt():
